...
public class RenameFile {
    ...
    public void renameFile(String fileid, String toname, String auth) {

        HttpClient client = new DefaultHttpClient();
        try {
            client.getConnectionManager().getSchemeRegistry().register(getMockedScheme());
            HttpGet GET = new HttpGet("https://api.pcloud.com/renamefile?toname=" + toname + "&fileid=" + fileid + "&auth=" + auth);
